...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Leestake " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"seedLeestake", "seed.Leestake.net"},
    {"seed", "seed.LEESoin.net"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"tseedLeestake", "tseed.Leestake.net"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Leestake is probably already running."), addrBind.ToString().c_str());
        else
