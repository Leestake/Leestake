 ...
 * LEESoin public-key-hash-addresses have version 55 (or 111 testnet).
...
public:
    enum
    {
        PUBKEY_ADDRESS = 55,  // LEESoin: addresses begin with 'P'
        SCRIPT_ADDRESS = 117, // LEESoin: addresses begin with 'p'
