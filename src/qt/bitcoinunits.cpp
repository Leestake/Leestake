...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("LEES");
    case mBTC: return QString("mLEES");
    case uBTC: return QString::fromUtf8("μLEES");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Leestakes");
    case mBTC: return QString("Milli-Leestakes (1 / 1,000)");
    case uBTC: return QString("Micro-Leestakes (1 / 1,000,000)");
    default: return QString("???");
    }
}
