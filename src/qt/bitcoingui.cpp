 ...
 * The Leestake developers 2011-2017
 */
    ...
    prevBlocks(0)
{
    ...
    setWindowTitle(tr("Leestake") + " - " + tr("Wallet"));
...
#ifndef Q_OS_MAC
    QApplication::setWindowIcon(QIcon(":icons/Leestake"));
    setWindowIcon(QIcon(":icons/Leestake"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Leestake address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/Leestake"), tr("&About Leestake"), this);
    aboutAction->setStatusTip(tr("Show information about Leestake"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Leestake"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/Leestake"), tr("&Show / Hide"), this);
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Leestake addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Leestake addresses"));

    openRPCConsoleAction = new QAction(QIcon(":/icons/debugwindow"), tr("&Debug window"), this);
    openRPCConsoleAction->setStatusTip(tr("Open debugging and diagnostic console"));

    openChatroomAction = new QAction(QIcon(":/icons/Leestake"), tr("&Chatroom"), this);
    openChatroomAction->setStatusTip(tr("Open https://Leestake.chat in a web browser."));

    openForumAction = new QAction(QIcon(":/icons/Leestake"), tr("&Forum"), this);
    openForumAction->setStatusTip(tr("Open https://talk.Leestake.net in a web browser."));
...
#ifndef Q_OS_MAC
            QApplication::setWindowIcon(QIcon(":icons/Leestake_testnet"));
            setWindowIcon(QIcon(":icons/Leestake_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/Leestake_testnet"));
#endif
            if(trayIcon)
            {
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Leestake client"));
...
void BitcoinGUI::openChatroom() {
    QDesktopServices::openUrl(QUrl("https://Leestake.chat"));
}

void BitcoinGUI::openForum() {
    QDesktopServices::openUrl(QUrl("https://talk.Leestake.net"));
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Leestake network", "", count));
}
...
{
    QString strTitle = tr("Leestake"); // default title
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Leestake address or malformed URI parameters."),
