...
// LEESoin: sync-checkpoint master key
...
// LEESoin: synchronized checkpoint (centrally broadcasted)
...
// LEESoin: get last synchronized checkpoint
...
// LEESoin: only descendant of current sync-checkpoint is allowed
...
// LEESoin: reset synchronized checkpoint to last hardened checkpoint
...
// LEESoin: find block wanted by given orphan block
...
// LEESoin: verify signature of sync-checkpoint message
...
// LEESoin: process synchronized checkpoint
...
// get information of sync-checkpoint (first introduced in LEESoin)
